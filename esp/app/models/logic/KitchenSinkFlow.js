  ...
  return {
    ...
    calc: function( report ) {
      ...
      if ( input ) {
        ...
        var d = e.reqres.request('score:get:kitchen-sink-duration');
    ...
    describe: function( desc ) {
      ...
      if (input) {
        ...
        if (userLang === "ESP") {
          choices = {
            Q4A1a: ' grifo de bajo flujo',
            Q4A1b: ' grifo de convencional'
          };
        } else {
          choices = {
            Q4A1a: ' low-flow faucets',
            Q4A1b: ' conventional faucets'
          };
        }  

...
define(function( require ){
  ...
  return Backbone.Model.extend({
    ...
    getTopicText: function() {
      //Returns the visible topic text.
      //Caters for multiple languages without breaking the app architecture and CSS.
      var topicText = this.getTopic();
      var userLang = this.getUserLang();
      if (userLang !== '') {
        topicText = this.get('topic'+userLang);
      }
      return topicText;
    },
    ...
    getQuestionText: function() { 
      //language awarenesss   
      var textGroup = 'textGroup'+this.getUserLang();
      var textIndividual = 'textIndividual'+this.getUserLang();
    ...
    getHelpText: function() { 
      //language awarenesss   
      var helpText = 'help'+this.getUserLang();
      return (this.get('question')[helpText]);  
    },

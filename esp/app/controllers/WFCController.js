...
define(function( require ){
  ...
  var WFCController = Marionette.Controller.extend({
    ...
    entitle : function(title, url){
      ...
      //if available, append the language path to the URL (e.g. /esp)
      var pageurl = url;
      if (window.location.href.indexOf("/esp") > -1) {
        langpath = "/esp";
        pageurl = langpath.concat(url);
      } 
    ...
    welcome: function() {
      ...
      this.entitle('¿Cuál es su Huella Hídrica?', "/");
    },
    ...
    renderQuestion: function( slug ) {
      ...
      // Page Dressing:
      this.entitle(question.get('topicESP'), "/q/"+ question.get("slug"));
    },
    ...
    renderComplete: function() {
      ...
      this.entitle('¿Cuál es su Huella Hídrica?', "/complete");
    },

...
define(function(require){
  ...
  return Marionette.ItemView.extend({
    ...
    twitter: function(evt) {
      evt.preventDefault();
      var msg = "Find out your #waterfootprint with GRACE’s Water Footprint Calculator www.watercalculator.org #savewater !";
      window.open('//twitter.com/home?status=' + encodeURIComponent(msg), '_blank' );
    ...
    facebook: function(evt) {
      evt.preventDefault();
      var msg = "Find out your WATER FOOTPRINT with GRACE’s Water Footprint Calculator www.watercalculator.org #savewater !";

...
define(function(require){
  ...
  var template = require("../templates/qui/recycling-metal-and-glass");

  var RecyclingMetalAndGlass = QuestionUIView.extend({

    nom: "RecyclingMetalAndGlass",
    template: template,
    gaEventCategory: "Recycle Metal and Glass",

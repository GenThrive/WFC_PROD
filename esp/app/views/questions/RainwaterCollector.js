...
define(function(require){
  ...
  var template = require("../templates/qui/rainwater-collector");


  var RainwaterCollector = QuestionUIView.extend({
    nom: "RainwaterCollector",
    template: template,
    gaEventCategory: "Rainwater Collector",

...
define(function(require){
  ...
  var template = require("../templates/qui/learned-the-most-about");

  var LearnedTheMostAbout = QuestionUIView.extend({

    nom: "LearnedTheMostAbout",
    template: template,
    gaEventCategory: "Learned the Most About",

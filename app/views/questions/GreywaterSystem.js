/*
* Graywater System Question View
*/

define(function(require){

  var QuestionUIView = require('./QuestionUIView');
  var template = require('../templates/qui/greywater-system');


  var GreywaterSystem = QuestionUIView.extend({
    nom: "GreywaterSystem",
    template: template,
    gaEventCategory: "Greywater System",

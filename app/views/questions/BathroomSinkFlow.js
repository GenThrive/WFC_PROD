/*
* Bathroom Sink Flow Question View
*/
...
define(function(require){
  ...
  var template = require("../templates/qui/bathroom-sink-flow");


  var BathroomSinkFlow = QuestionUIView.extend({


    nom: "BathroomSinkFlow",
    template: template,
    gaEventCategory: "Bathroom Sink Flow",

/*
* Kitchen Sink Flow Question View
*/
...
define(function(require){
  ...
  var template = require("../templates/qui/kitchen-sink-flow");


  var KitchenSinkFlow = QuestionUIView.extend({


    nom: "KitchenSinkFlow",
    template: template,
    gaEventCategory: "Kitchen Sink Low Flow Faucets",

...
define(function( require ){
  ...
  var template       = require("../templates/qui/diet-distribution");
  ...
  var DietDistribution = QuestionUIView.extend({
    ...
    template: template,
    className: 'group-ui',
    gaEventCategory: "Diet Distribution",
    ...
    initialize: function() {
      _.bindAll(this);
      var n = e.reqres.request('household:size');
    ...
    removeMember: function(evt) {
      ...
      e.commands.execute('meat:overage');
    },

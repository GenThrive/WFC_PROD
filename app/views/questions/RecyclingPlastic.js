...
define(function(require){
  ...
  var template = require("../templates/qui/recycling-plastic");

  var RecyclingPlastic = QuestionUIView.extend({

    nom: "RecyclingPlastic",
    template: template,
    gaEventCategory: "Recycle Plastic",

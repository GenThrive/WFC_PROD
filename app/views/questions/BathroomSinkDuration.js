/*
* Bathroom Sink Duration Question View
*/

define(function(require){

  var QuestionUIView = require("./QuestionUIView");
  var template = require("../templates/qui/bathroom-sink-duration");

  var BathroomSinkDuration = QuestionUIView.extend({


    nom: "BathroomSinkDuration",
    template: template,
    gaEventCategory: "Bathroom Sink Duration",

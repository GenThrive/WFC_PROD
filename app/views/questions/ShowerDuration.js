...
define(function(require){
  ...
  var template = require("../templates/qui/shower-duration");

  var ShowerDuration = QuestionUIView.extend({

    nom: "ShowerDuration",
    gaEventCategory: "Shower Duration",
    template: template,
    ...
    onChoice: function(evt) {
      ...
      $(evt.currentTarget).addClass('chosen');
      var evtLabel = $(evt.currentTarget).children()[0].innerHTML;
      ga('send', 'event', {

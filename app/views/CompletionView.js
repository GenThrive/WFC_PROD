...
define(function( require ){
  ...
  var CompletionView = Marionette.ItemView.extend({
    ...
    twitter: function(evt) {
      evt.preventDefault();
      var msg ="1,802 gallons a day. That's the average water footprint of someone in the US! Mine is " + e.reqres.request('score:current:formatted') + " gal/day. Find yours at www.watercalculator.org";
